...
using WebApp_training.Presentations.Controllers;
using WebApp_training.Presentations.ViewModels;
namespace WebApp_training.Presentations.Extensions;
/// <summary>
/// 依存定義および依存性注入クラス
/// </summary>
public static class DependencyExtension
{
    ...
    private static void SettingPresentations(IServiceCollection services)
    {
        ...
        services.AddScoped(
            provider =>
            new TempDataStore<DepartmentListItemViewModel>("DepartmentListItemViewModel")
            );
